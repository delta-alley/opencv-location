...
//TODO: Modify this to use org.opencv instead of org.bytedeco
...
public class FaceRecognizerDemo {
    public static int Match(Mat testImage, String trainingDir) {
        //Mat testImage = imread(input, CV_LOAD_IMAGE_GRAYSCALE);
        ...
        opencv_core.Mat labels = new Mat(imageFiles.length, 1, CV_32SC1);
